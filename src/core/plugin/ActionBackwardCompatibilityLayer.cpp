...
static const std::map<std::string_view, ToolType> SELECT_TOOL_MAP = {
        ...
        {"ACTION_TOOL_LASER_POINTER_PEN"sv, TOOL_LASER_POINTER_PEN},
        {"ACTION_TOOL_LASER_POINTER_HIGHLIGHTER"sv, TOOL_LASER_POINTER_HIGHLIGHTER}};
...
static const std::map<std::string_view, Action> BOOLEAN_ACTION_MAP = {
        ...
        {"ACTION_TOOL_DRAW_GAUSSIAN"sv, Action::TOOL_DRAW_GAUSSIAN},
        {"ACTION_TOOL_DRAW_SINUS"sv, Action::TOOL_DRAW_SINUS},
        {"ACTION_TOOL_DRAW_POLYNOMIAL"sv, Action::TOOL_DRAW_POLYNOMIAL},
        {"ACTION_TOOL_DRAW_EXP"sv, Action::TOOL_DRAW_EXP},
