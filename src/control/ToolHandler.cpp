...
void ToolHandler::initTools() {
    ...
    tools[TOOL_PEN - TOOL_PEN] = std::make_unique<Tool>(
            ...
            TOOL_CAP_COLOR | TOOL_CAP_SIZE | TOOL_CAP_RULER | TOOL_CAP_RECTANGLE | TOOL_CAP_ELLIPSE | TOOL_CAP_ARROW |
                    TOOL_CAP_SPLINE | TOOL_CAP_GAUSS| TOOL_CAP_POLY| TOOL_CAP_SINUS | TOOL_CAP_RECOGNIZER | TOOL_CAP_FILL | TOOL_CAP_DASH_LINE,
            thickness);
    ...
    tools[TOOL_HIGHLIGHTER - TOOL_PEN] = std::make_unique<Tool>(
            ...
            TOOL_CAP_COLOR | TOOL_CAP_SIZE | TOOL_CAP_RULER | TOOL_CAP_RECTANGLE | TOOL_CAP_ELLIPSE | TOOL_CAP_ARROW |
                    TOOL_CAP_SPLINE | TOOL_CAP_GAUSS | TOOL_CAP_POLY| TOOL_CAP_SINUS | TOOL_CAP_RECOGNIZER | TOOL_CAP_FILL,
            thickness);
...
auto ToolHandler::isSinglePageTool() -> bool {
    ...
    return toolType == (TOOL_PEN && (drawingType == DRAWING_TYPE_ARROW || drawingType == DRAWING_TYPE_ELLIPSE ||
                                     ...
                                     drawingType == DRAWING_TYPE_GAUSS || drawingType == DRAWING_TYPE_POLY ||
           ...
           toolType == TOOL_FLOATING_TOOLBOX || toolType == TOOL_DRAW_SPLINE || toolType == TOOL_DRAW_GAUSS ||
           toolType == TOOL_DRAW_POLY || toolType == TOOL_DRAW_SINUS;
}
